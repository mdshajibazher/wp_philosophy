        ...
        <div class="row top">
            ...
            <div class="col-eight md-six tab-full popular">
                ...
                <div class="block-1-2 block-m-full popular__posts">
                    <?php $philosophy_populer_post = new WP_Query(array(
                        'posts_per_page' => 6,
                    ...
                    while($philosophy_populer_post->have_posts()) : $philosophy_populer_post->the_post(); 
                    ?>
                    <article class="col-block popular__post">
                        ...
                        <section class="popular__meta">
                            ...
                            <span class="popular__date"><span><?php _e('On','philosophy') ?></span> <time datetime="2017-12-19"><?php echo esc_html(get_the_date('F, d, Y')); ?></time></span>
                        </section>
                    </article>
